;*=====================================================================*/
;*    serrano/prgm/project/biglook/peer/swing/Lswing/_swing.scm        */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Thu Apr 19 08:57:56 2001                          */
;*    Last change :  Mon Jul 16 11:23:08 2001 (serrano)                */
...
(module __biglook_%swing
   ...
   (java   (class %swing-icon::%jobject
	   ...
	   (class %swing-jscrollpane::%swing-jcomponent
	      ...
	      (constructor new/policy (::%awt-component ::int ::int))
