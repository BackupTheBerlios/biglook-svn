...
(define (%text-background ::%bglk-object)
   (not-implemented o "%text-background"))

(define (%text-background-set! ::%bglk-object ::%rgb-color)
   (not-implemented o "%text-background-set!"))

(define (%text-font ::%bglk-object)
   (not-implemented o "%text-font"))

(define (%text-font-set! ::%bglk-object ::%rgb-color)
...
(define (%text-put-props! t::%bglk-object start::int end::int props::pair-nil)
