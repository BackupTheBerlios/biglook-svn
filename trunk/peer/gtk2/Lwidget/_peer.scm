...
(module __biglook_%peer
   ...
   (extern
    ...
    (type gtktreeview*        (opaque) "GtkTreeView*")
    (type gtktreemodel*       (opaque) "GtkTreeModel*")
    (type gtktreepath*        (opaque) "GtkTreePath*")
    (type gtktreeselection*   (opaque) "GtkTreeSelection*")
    (type gtkliststore*       (opaque) "GtkListStore*")
    (type gtktextview*        (opaque) "GtkTextView*")
    (type gtktextbuffer*      (opaque) "GtkTextBuffer*")
    (type gtktextiter*        (opaque) "GtkTextIter*")
    ...
    (type pangofont*          (opaque) "PangoFontDescription*")

    (macro opaque::obj      (opaque) "(obj_t)")
    
    (macro G-TYPE-INT::int "G_TYPE_INT")
    (macro G-TYPE-UINT::int "G_TYPE_UINT")
    (macro G-TYPE-ULONG::int "G_TYPE_ULONG")
    (macro G-TYPE-FLOAT::int "G_TYPE_FLOAT")
    (macro G-TYPE-POINTER::int "G_TYPE_POINTER")
    (macro G-TYPE-ENUM::int "G_TYPE_ENUM")
    ...
    (macro G-TYPE-BOOL::int "G_TYPE_BOOL")
    (macro GTK-TYPE-PROGRESS-BAR-STYLE::int "GTK_TYPE_PROGRESS_BAR_STYLE")
    (macro GNOME-TYPE-CANVAS-POINTS::int "GNOME_TYPE_CANVAS_POINTS")
    (macro G-TYPE-BOXED::int "G_TYPE_BOXED")
    ...
    (macro G-TYPE-OBJECT::int "G_TYPE_OBJECT")
    (macro G-TYPE-STRING::int "G_TYPE_STRING")
    ...
    ;; Cast
    (macro gobject::gobject* (::gtkobject*) "G_OBJECT")
    ...
    (macro gtkclist::gtkclist* (::gtkobject*)
	   "GTK_CLIST")
    (macro gtktreeview::gtktreeview* (::gtkobject*)
	   "GTK_TREE_VIEW")
    (macro gtktextview::gtktextview* (::gtkobject*)
	   "GTK_TEXT_VIEW")
    ...
    (macro %%gtkadjustment->gtkobject::gtkobject* (::gtkadjustment*)
	   "GTK_OBJECT")
    (macro %%gtkadjustment->gobject::gobject* (::gtkadjustment*)
	   "G_OBJECT")
    (macro %%gtktreeview->gtkobject::gtkobject* (::gtktreeview*)
	   "GTK_OBJECT")
    (macro %%obj->gpointer::gpointer (::obj)
	   "(gpointer)")
    (macro %%gtkcontainer->gtkwidget::gtkwidget* (::gtkcontainer*)
	   "GTK_WIDGET")
    (macro gtkliststore->gtktreemodel::gtktreemodel* (::gtkliststore*)
	   "GTK_TREE_MODEL")
...
(define (peer-%bglk-object peer::%peer)
  (with-access::%peer peer (%builtin)
      (%bglk-g-property-get (gobject %builtin) "user-data")))
...
(define (peer-%bglk-object-set! peer::%peer v)
  (flush-output-port (current-output-port))
   (with-access::%peer peer (%builtin)
      (%bglk-g-property-type-set! (gobject %builtin) "user-data" v G-TYPE-POINTER)))
