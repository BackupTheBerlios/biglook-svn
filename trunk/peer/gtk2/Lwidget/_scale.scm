...
(define (%make-%scale o adjustment::gtkadjustment* scale::gtkwidget*)
   ...
   ;; will be changed
   (%bglk-g-property-type-set! (%%gtkadjustment->gobject adjustment)
			       "user-data"
			       o
			       G-TYPE-POINTER)
   (%bglk-g-property-type-set! (gobject (gtkobject scale)) "digits" 0 G-TYPE-INT)
   (instantiate::%scale
