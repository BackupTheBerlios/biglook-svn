...
/*---------------------------------------------------------------------*/
/*    static GtkWidget *                                               */
/*    gtk_pixbuf_to_gtk_pixmap ...                                     */
/*---------------------------------------------------------------------*/
static GtkWidget *
gtk_pixbuf_to_gtk_pixmap( GdkPixbuf *pixbuf ) {
    GtkWidget *pixmapwid;
    GdkPixmap *pixmap;
    GdkBitmap *mask;
...
bglk_gtk_file_image_new( char *filename ) {
   ...
   pixbuf = gdk_pixbuf_new_from_file( filename, NULL ); /* !!!! Better handle GErrors!!! -- goga */

   res = gtk_pixbuf_to_gtk_pixmap( pixbuf );
...
bglk_gtk_data_image_new( char *buffer, char *mask ) {
   ...
   return gtk_pixbuf_to_gtk_pixmap( pixbuf );
}
...
bglk_gtk_image_duplicate( GtkObject *img ) {
   return gtk_pixbuf_to_gtk_pixmap( bglk_gtk_image_to_pixbuf( img ) );
}
