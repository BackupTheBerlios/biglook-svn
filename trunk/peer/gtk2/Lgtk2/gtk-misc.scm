...
(module __biglook_%gtk-misc
   ...
   (extern (macro %%widget-show::void
	   ...
	   (macro %bglk-g-property-get::obj
		  (::gobject* ::string)
		  "bglk_g_property_get")
	   (macro %bglk-g-property-set!::obj
		  (::gobject* ::string ::obj)
		  "bglk_g_property_set")
	   (macro %bglk-g-property-type-set!::obj
		  (::gobject* ::string ::obj ::int)
		  "bglk_g_property_type_set")
	   (macro %%bglk-g-property-gtkobject-set!::obj
		  (::gobject* ::string ::gtkobject*)
	   ...
	   ;; reshow
	   (macro %%bglk-window-reshow-with-initial-size::void (::gtkwidget*)
		  "bglk_window_reshow_with_initial_size")
	   ...
	   (macro %%pango-font::pangofont* (::string)
		  "pango_font_description_from_string"))
   
   (export (g-property-get ::%bglk-object ::bstring)
	   (g-property-set! ::%bglk-object ::bstring ::obj)
	   (g-property-type-set! ::%bglk-object ::bstring ::obj ::int)
...
;*    g-property-get ...                                                  */
;*---------------------------------------------------------------------*/
(define (g-property-get o::%bglk-object name::bstring)
   (with-access::%bglk-object o (%peer)
      (%bglk-g-property-get (gobject (%peer-%builtin %peer)) name)))

;*---------------------------------------------------------------------*/
;*    g-property-set! ...                                                 */
;*---------------------------------------------------------------------*/
(define (g-property-set! o::%bglk-object name::bstring v::obj)
  (with-access::%bglk-object o (%peer)
      (%bglk-g-property-set! (gobject (%peer-%builtin %peer)) name v)))

;*---------------------------------------------------------------------*/
;*    gtk-arg-type-set! ...                                            */
;*---------------------------------------------------------------------*/
(define (g-property-type-set! o::%bglk-object name::bstring v::obj t::int)
  (with-access::%bglk-object o (%peer)
      (%bglk-g-property-type-set! (gobject (%peer-%builtin %peer)) name v t)))
