...
/*    Arguments                                                        */
/*---------------------------------------------------------------------*/
extern obj_t bglk_gtk_arg_get( GtkObject *, char * );
extern obj_t bglk_gtk_arg_set( GtkObject *, char *, obj_t );
extern obj_t bglk_gtk_arg_type_set( GtkObject *, char *, obj_t, int );
extern obj_t bglk_gtk_arg_gtkobject_set( GtkObject *, char *, GtkObject * );
...
#define BGLK_GTK_PIXBUF_TYPE_SET( o, s, p ) \
   bglk_gtk_arg_type_set( (o), (s), (obj_t)(p), GTK_TYPE_POINTER )
...
/*    Toolbar                                                          */
/*---------------------------------------------------------------------*/
#define BGLK_TOOLBAR_ORIENTATION( _tb ) \
   (((GtkToolbar *)_tb)->orientation)

#define BGLK_TOOLBAR_SPACE_SIZE( _tb ) \
   (((GtkToolbar *)_tb)->space_size)

#define BGLK_TOOLBAR_STYLE( _tb ) \
   (((GtkToolbar *)_tb)->style)
