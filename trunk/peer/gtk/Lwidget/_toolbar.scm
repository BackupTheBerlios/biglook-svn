...
(module __biglook_%toolbar
   ...
   (extern  (macro %%gtk-toolbar-new::gtkwidget*
	    ...
	    (macro %%gtk-toolbar-set-space-size::void
		   (::gtktoolbar* ::int)
		   "gtk_toolbar_set_space_size")
	    (macro %%gtk-toolbar-set-relief::void
		   (::gtktoolbar* ::int)
...
(define (%make-%toolbar o::%bglk-object floating)
   (let ((tl (%%gtk-toolbar-new %%gtk-toolbar-orientation-horizontal 0)))
      (if floating
...
(define (%make-floating-toolbar o::%bglk-object tl::gtkwidget*)
   (let ((handle (gtkobject (%%gtk-handle-new))))
      ...
      (%bglk-gtk-arg-type-set! (gtkobject tl) "user_data" o GTK-TYPE-POINTER)
...
(define (%toolbar-relief-set! o::%bglk-object v::symbol)
   (with-access::%toolbar (%bglk-object-%peer o) (%toolbar)
      (%%gtk-toolbar-set-relief %toolbar (biglook-relief->gtk v))
      o))
...
(define (%toolbar-space-size-set! o::%bglk-object v::int)
   (with-access::%toolbar (%bglk-object-%peer o) (%toolbar)
      (%%gtk-toolbar-set-space-size %toolbar v)
      o))
