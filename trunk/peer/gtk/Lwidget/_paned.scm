...
(module __biglook_%paned
   ...
   (extern (macro %%gtk-hpaned-new::gtkwidget* ()
	   ...
	   (macro %%gtk-paned-set-handle-size::void (::gtkpaned* ::int)
		  "gtk_paned_set_handle_size")
	   (macro %%gtk-paned-set-gutter-size::void (::gtkpaned* ::int)
...
(define (%make-%paned o::%bglk-object widget::gtkwidget*)
   (let ((owidget::gtkobject* (gtkobject widget)))
      (%%gtk-paned-set-handle-size (gtkpaned owidget) 10)
      (%%gtk-paned-set-gutter-size (gtkpaned owidget) 15)
