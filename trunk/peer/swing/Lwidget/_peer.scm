...
(module __biglook_%peer
   ...
   (java   (class %bglk-box
	      (constructor new (::int))
	      (field static EXPAND::int "EXPAND")
	      (field static FILL::int "FILL")
	      "bigloo.biglook.peer.Jlib.BJBox")
	   
	   (class %bglk-jcomponentadapter::%awt-componentadapter
	      (constructor new ())
	   ...
	   ;; BJTableModelAdpater
	   (class %bglk-table-modeladapter::%swing-tablemodellistener
	      (method static add!::void
		      (::%swing-tablemodel ::obj ::obj ::procedure)
		      "addTableModelAdapter")
	      (method static proc::obj
		      (::%swing-tablemodel)
		      "getTableModelAdapterProc")
	      "bigloo.biglook.peer.Jlib.BJTableModelAdapter")
	   ...
	   ;; BJTable
	   (class %bglk-table::%swing-jtable
	      (constructor new (::%swing-tablemodel))
	      "bigloo.biglook.peer.Jlib.BJTable")
	      
	   ;; BJTableModel
	   (class %bglk-tablemodel::%swing-abstracttablemodel
	      (constructor new
			   (::obj ::vector ::procedure ::procedure))
	   ...
	   ;; BJText
	   (class %bglk-text
	      (method static caret->line/column::pair (::%swing-jtextpane ::int)
		      "caretToLineColumn")
	      (method static put-props!::void (::%swing-jtextpane ::int ::int)
		      "putProperties")
	      "bigloo.biglook.peer.Jlib.BJText")
	   ...
	   (class %bglk
	      ...
	      (method static object->jobject::%jobject
		      (::object)
		      "object_to_jobject")
	      (method static string->jstring::%jstring
		      (::obj)
		      "string_to_jstring")
	      ...
	      (method static tree-node-items::pair-nil
		      (::%swing-treenode)
		      "bglk_treenode_items")
	      (method static tree-coords->item::obj
		      (::%swing-jtree ::int ::int)
		      "bglk_tree_coords_to_item")
...
(define-generic (%peer-init peer::%peer)
   (if (not (eq? (%peer-%builtin peer) #unspecified))
       (begin
