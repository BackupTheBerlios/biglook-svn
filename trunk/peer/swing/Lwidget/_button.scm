;*=====================================================================*/
;*    swing/Lwidget/_button.scm                                        */
;*    -------------------------------------------------------------    */
;*    Author      :  Manuel Serrano                                    */
;*    Creation    :  Sat Mar 24 09:14:39 2001                          */
;*    Last change :  Tue Apr 27 15:22:40 2004 (dciabrin)               */
...
(module __biglook_%button
   ...
   (export (class %button::%peer
	   ...
	   (%button-text-set! ::%bglk-object ::obj)
...
;*    %button-text-set! ...                                            */
;*---------------------------------------------------------------------*/
(define (%button-text-set! o::%bglk-object v::obj)
   (with-access::%bglk-object o (%peer)
      (%swing-abstractbutton-text-set! (%peer-%builtin %peer)
				       (%bglk-string->jstring v))
      o))
...
(define (%button-relief-set! o::%bglk-object v)
   (with-access::%button (%bglk-object-%peer o) (%builtin)
	  ...
	  (begin
	     ...
	     v)
	  (begin
	     (%swing-abstractbutton-isborderpainted-set! %builtin #t)
	     v))))
